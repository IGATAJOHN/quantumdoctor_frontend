...
const AudioCall: React.FC<AudioCallProps> = ({
  ...
  return (
    <div className="relative w-full h-full min-h-[600px] bg-[#3b392d] text-white flex flex-col">
      <div className="p-4">
      ...
      <div className="flex-1 flex flex-col items-center justify-center gap-8">
        ...
        <div className="relative">
          <div className="w-32 h-32 rounded-lg bg-[#e4a853] overflow-hidden">
            <img
              src={doctorImage}
              alt={doctorName}
        ...
        <div className="absolute bottom-24 right-4 w-20 h-20 bg-[#4a4a4a] rounded-lg overflow-hidden">
          <img
            src={patientImage}
            alt={patientName}
            className="w-full h-full object-cover"
